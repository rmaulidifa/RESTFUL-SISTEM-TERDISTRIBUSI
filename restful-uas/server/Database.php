...
class Database{
    ...
    {
        $query = $this->conn->prepare("SELECT id_pasien, nama_pasien from pasien where id_pasien=?");
    ...
    {
        $query = $this->conn->prepare("insert ignore into pasien (id_obat, nama_pasien) values (?,?)");
        $query->execute(array($data['id_obat'],$data['nama_pasien']));
    ...
    {
        $query = $this->conn->prepare("update pasien set nama_pasien=? where id_pasien=?");
        $query->execute(array($data['nama_pasien'], $data['id_pasien']));
